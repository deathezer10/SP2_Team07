...
CharacterRenderer::CharacterRenderer(Mesh * meshlist, unsigned * mParameter, MS* mStack, MS* vStack, MS* pStack)
	: modelStack(mStack), viewStack(vStack), projectionStack(pStack) {

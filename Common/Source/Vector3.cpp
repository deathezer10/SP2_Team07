...
/******************************************************************************/
/*!
\brief  Returns the string representation of the Vector3
*/
/******************************************************************************/
std::string Vector3::toString() {
	std::ostringstream buff;
	buff << "x: " << (int)x << ", y: " << (int)y << ", z: " << (int)z;
	return  buff.str();
}
...
*/
/******************************************************************************/
Vector3& Vector3::Set(float a, float b, float c) {
	x = a;
	y = b;
	z = c;
	return *this;

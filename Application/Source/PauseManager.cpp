...
void PauseManager::RenderPauseMenu(){
	...
	_scene->textManager.RenderMeshOnScreen(_scene->meshList[Scene::GEO_HP_BACKGROUND], (Application::_windowWidth / 10) * 0.375f, Application::_windowHeight / 25, Vector3(0, 0, 0), Vector3(10, 12, 1));
